...
import { projetoSchema, type ProjetoDTO } from "../../validation/projects.schema";
// import { projetoEditSchema, type ProjetoEditDTO } from "../../validation/projects.schema.edit";
...
export const EditeProjects = () => {
    ...
    const {
        ...
        ProjetoDTO & { imagemTitulo?: string[], imagemDescricao?: string[] }
    >({
    ...
    useEffect(() => {
        ...
        async function loadProject() {
            try {
                ...
                console.log("Projeto carregado:", response.data);
            } catch (error) {
    ...
    useEffect(() => {
        ...
        reset({
            ...
            repositorio_privado: project.repositorio_privado,
